...
remapped <- mclapply(seq(1, 50), function(n){
...
write_tsv(remapped, file="/home/rheinnec/logs/res_mclapply_detectCores_onecpu.tsv")
t1 <- Sys.time()
print(t1-t0)
print(paste("cores detected and used:", detectCores()))
